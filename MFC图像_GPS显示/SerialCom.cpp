...
BOOL CSerialCom::InitPort(CWnd* pPortOwner, // the owner (CWnd) of the port (receives message)
	...
	UINT  baud,   // baudrate
	char  parity,  // parity  N=None无校验 E=Even偶校验 O=Odd奇校验
	...
	UINT  writebuffersize) // size to the writebuffer
{
	...
	TRACE("Initialisation for communicationport %d completed./nUse Startmonitor to communicate./r/n", portnr);
	return TRUE;
}
//
...
UINT CSerialCom::CommThread(LPVOID pParam)
{
	...
	// a pointer of CSerialCom class//将传递给线程的void指针强制转换回CSerialCom类的指针
